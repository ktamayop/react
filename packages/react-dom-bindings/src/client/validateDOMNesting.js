...
const VALID_TAGS = [
    ...
    'hgroup', 'main', 'menu', 'nav', 'ol', 'p', 'section', 'summary', 'ul', 'pre',
    'listing', 'table', 'hr', 'xmp', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'
];

function getAncestorInfoForTag(tagName, ancestorInfoObj = {}) {
    const info = ancestorInfoObj[tagName]
        ?? ancestorInfoObj.pTagInButtonScope
        ?? (tagName === 'form' && ancestorInfoObj.formTag);
